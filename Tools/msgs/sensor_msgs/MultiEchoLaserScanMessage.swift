//
//  MultiEchoLaserScanMessage.swift
//
...
public class MultiEchoLaserScanMessage: RBSMessage {
	...
	public var ranges: LaserEchoMessage[]? = [LaserEchoMessage[]]()
	public var +Inf: #
	public var -Inf: #
	public var intensities: LaserEchoMessage[]? = [LaserEchoMessage[]]()
	public var device: #
	public var the: #
	...
	ranges = LaserEchoMessage[]()
	intensities = LaserEchoMessage[]()
	}
